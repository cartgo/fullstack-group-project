...
export class ProjectService {
  ...
  addResource() {
    let api =
      'http://localhost:8080/project/addResource?resourceCode=' +
      '2' +
      '&projectCode=33' +
      '&userId=1';
    return this.http
      .put<Resource>(api, {})
      .subscribe((data) => this.resources.push(data));
  }

  getResource() {
    let api =
      'http://localhost:8080/project/getProjectResource?projectCode=33&userId=1';
    return this.http
      .get<Resource[]>(api)
  ...
  deleteResource() {
    let api =
      'http://localhost:8080/project/getProjectResource?projectCode=33&userId=1';
    return this.http.delete<Resource[]>(api).subscribe(
      (data) =>
        (this.resources = data.filter((ele) => {
          return ele.resourceCode !== 4;
        }))
    );
  }
  ...
  ///////////////////////////////////////////////【【【【【【【【【【【【【【【【【【【【【【【【【【【【【【//////////////////////
  addPost(resource: Project) {
    //// ///////////////////////test, should be Resource[]
